...
Route::get('/home', [crud_controller::class, 'index'])->name('user.index');
Route::get('home/add', [crud_controller::class, 'create'])->name('user.create');
Route::post('home/add', [crud_controller::class, 'store'])->name('user.store');
Route::get('home/add', [crud_controller::class, 'create'])->name('user.create');
